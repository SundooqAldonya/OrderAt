...
const useEnvVars = (env = Updates.channel) => {
  ...
  if (env === 'production' || env === 'staging') {
    return {
      ...
      ANDROID_CLIENT_ID_GOOGLE: '133710632137-p9iabf8cgdg4rjsdmj1mcn305ppc33h2.apps.googleusercontent.com',
  ...
  return {
    ...
    GRAPHQL_URL: 'http://145.223.23.186:8001/graphql',
    WS_GRAPHQL_URL: 'ws://145.223.23.186:8001/graphql',
    SERVER_URL: 'http://145.223.23.186:8001/',
    IOS_CLIENT_ID_GOOGLE: configuration.iOSClientID,
    ANDROID_CLIENT_ID_GOOGLE: '133710632137-p9iabf8cgdg4rjsdmj1mcn305ppc33h2.apps.googleusercontent.com',
    AMPLITUDE_API_KEY: configuration.appAmplitudeApiKey,
