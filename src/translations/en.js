const en = {
  translation: {
    ...
    addYourBusinessDesc: "Partner with Orderat and reach more customers. We handle delivery, so you can focus on the food.",
    getStarted: "Get Started",
    driveWithOrderat: "Drive with Orderat",
    driveWithOrderatDesc: "Set your own schedule, be your own boss, and earn money by delivering with Orderat.",
    signUpToDeliver: "Sign up to deliver",
    downloadOurApp: "Download our app",
    downloadOurAppDesc: "Get the best Orderat experience with our mobile app.",
    android: "Android",
    ios: "iOS",
    addYourBusinessTitle: "Add Your Business",
    businessNameLabel: "Business Name",
    businessAddressLabel: "Business Address",
    contactPersonNameLabel: "Contact Person Name",
    phoneNumberLabel: "Phone Number",
    phoneNumberHelper: "Enter phone number with country code",
    submitApplication: "Submit Application",
    submitting: "Submitting...",
    applicationSuccess: "Application submitted successfully!",
    applicationFail: "Failed to submit application. Please try again.",
