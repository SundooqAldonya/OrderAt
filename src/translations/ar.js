const ar = {
  translation: {
    ...
    addYourBusiness: "أضف نشاطك التجاري",
    addYourBusinessDesc: "شارك مع Orderat ووصل إلى المزيد من العملاء. نحن نتولى التوصيل، حتى تتمكن من التركيز على الطعام.",
    getStarted: "ابدأ الآن",
    driveWithOrderat: "قد مع Orderat",
    driveWithOrderatDesc: "حدد جدولك الزمني بنفسك، كن رئيسك الخاص، واكسب المال عن طريق التوصيل مع Orderat.",
    signUpToDeliver: "سجّل للتوصيل",
    downloadOurApp: "حمّل تطبيقنا",
    downloadOurAppDesc: "احصل على أفضل تجربة Orderat عبر تطبيقنا المحمول.",
    android: "أندرويد",
    ios: "آي أو إس",
    addYourBusinessTitle: "أضف نشاطك التجاري",
    businessNameLabel: "اسم النشاط التجاري",
    businessAddressLabel: "عنوان النشاط التجاري",
    contactPersonNameLabel: "اسم الشخص المسؤول عن الاتصال",
    phoneNumberLabel: "رقم الهاتف",
    phoneNumberHelper: "أدخل رقم الهاتف مع رمز البلد",
    submitApplication: "إرسال الطلب",
    submitting: "جاري الإرسال...",
    applicationSuccess: "تم إرسال الطلب بنجاح!",
    applicationFail: "فشل في إرسال الطلب. يرجى المحاولة مرة أخرى.",
    businessNameRequired: "اسم النشاط التجاري مطلوب",
    businessAddressRequired: "عنوان النشاط التجاري مطلوب",
    contactNameRequired: "اسم الشخص المسؤول عن الاتصال مطلوب",
