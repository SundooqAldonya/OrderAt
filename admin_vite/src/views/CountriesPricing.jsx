...
import CityPricingForm from "../components/CityPricingForm";
import CountryPricingForm from "../components/CountryPricingForm";
...
const CountriesPricing = () => {
  ...
  const { data, loading, refetch } = useQuery(getAllCountryPricing);

  const pricingList = data?.getAllCountryPricing || null;

  console.log({ data });

  const [removeCity] = useMutation(deleteCountryPricing, {
    onCompleted: (data) => {
      console.log({ dataResponse: data });
      setSuccess(true);
      setType("success");
      setMessage(data.deleteCityPricing.message);
    },
  ...
  return (
    <Fragment>
      ...
      <Container className={globalClasses.flex} fluid>
        ...
        >
          <CountryPricingForm editData={item} onClose={closeEditModal} />
        </Modal>
      </Container>
    </Fragment>
  );
...
export default CountriesPricing;
