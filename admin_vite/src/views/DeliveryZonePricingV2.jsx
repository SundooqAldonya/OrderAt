...
import DeliveryZonePricingFormV2 from "../components/DeliveryZonePricingFormV2";

const GET_CITIES = gql`
  ${getCities}
`;

const DeliveryZonePricingV2 = () => {
  ...
  const { data, loading, refetch } = useQuery(getAllZonePricing);
  ...
  const dataList = data?.getAllZonePricing || null;
  ...
  const columns = [
    ...
    {
      name: t("Origin"),
      selector: (row) => row.originZone?.title,
      sortable: true,
    },
    {
      name: t("Destination"),
      selector: (row) => row.destinationZone?.title,
      sortable: true,
    },
    {
      name: t("Active"),
  ...
  return (
    <Fragment>
      ...
      <Container className={globalClasses.flex} fluid>
        ...
        >
          <DeliveryZonePricingFormV2 editData={item} onClose={closeEditModal} />
        </Modal>
      </Container>
    </Fragment>
  );
...
export default DeliveryZonePricingV2;
