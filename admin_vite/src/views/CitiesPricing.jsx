...
const CitiesPricing = () => {
  ...
  const { data, loading, refetch } = useQuery(getAllCityPricing);

  const pricingList = data?.getAllCityPricing || null;

  console.log({ pricingList });

  const [removeCity] = useMutation(deleteCityPricing, {
    onCompleted: (data) => {
  ...
  return (
    <Fragment>
      ...
      <Container className={globalClasses.flex} fluid>
        ...
        >
          <CityPricingForm editData={item} onClose={closeEditModal} />
        </Modal>
      </Container>
    </Fragment>
  );
